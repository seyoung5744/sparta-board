...
import com.example.basicboard.dto.UpdatePasswordRequestDto;
...
public class MemberController {
    ...
    @PatchMapping("/{id}")
    public ResponseEntity<Void> updatePassword(@PathVariable Long id, @RequestBody UpdatePasswordRequestDto request) {
